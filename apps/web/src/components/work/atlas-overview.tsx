...
} from "@assembly/content";
import { formatYears } from "../../lib/format";
import { AtlasCity } from "./atlas-city";
import type { AtlasCityProject } from "./atlas-layout";
 ...
 * atlas data (`getAtlasSummary`), so the counts cannot drift from the atlas data.
 */
export function AtlasOverview() {
  ...
  const cityProjects: AtlasCityProject[] = atlasProjects.map((project) => ({
    id: project.id,
    name: project.name,
    ...
    domainFromName: project.domainFromName,
    product: project.product,
    personalWork: project.personalWork,
    notableWork: project.notableWork,
    hasDetail: detailed.has(project.id),
    years: project.years ? formatYears(project.years) : undefined,
    client: project.client,
    enterpriseClient: project.enterpriseClient,
  ...
  return (
    ...
    >
      ...
      <AtlasCity projects={cityProjects}>
